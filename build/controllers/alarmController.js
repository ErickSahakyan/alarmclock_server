...
import Alarm from '../models/Alarm.ts';
...
export const getMyAlarms = async (req, res) => {
    try {
        ...
        const list = await Promise.all(user.alarms.map(alarm => {
...
export const toggleCondition = async (req, res) => {
    try {
...
export const removeAlarm = async (req, res) => {
    try {
...
export const changeAlarm = async (req, res) => {
    try {
        const { time, text, condition, weekday } = req.body;
...
export const duplicateAlarm = async (req, res) => {
    try {
